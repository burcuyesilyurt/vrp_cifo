...
#, ['C106', 'cd', '2.0', '60.0', '-5.0', '77.0', '107.0', '10.0', 'C73']]
...
if __name__ == "__main__":
    ...
    # [vrp_xo(data, max_vehicles, cycle_xo), vrp_xo(data, max_vehicles, pmx),  vrp_xo_random(data, max_vehicles, single_point_xo), sequential_constructive_xo(data)]
    ...
    # #XO: Single_point, cycle_xo, pmx, constructive_xo
    # #selective = tournament, fps

    # P.evolve(gens=50,
    #          xo_prob=1,
    #          mut_prob=0.20,
    #          select=tournament_sel,
    #          xo=vrp_xo(data, max_vehicles, cycle_xo),
